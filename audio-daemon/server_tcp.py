...
The server runs on TCP port 8080 for better Docker compatibility.
"""
...
from capture_parec import AudioCapture, AudioConfig
...
class AudioDaemon:
    ...
    def get_status(self) -> dict:
        ...
        if self.state.is_recording and self.state.started_at:
            ...
            status["chunks_recorded"] = self.capture.current_chunk if self.capture else 0
...
if __name__ == "__main__":
    ...
    run_server(host=args.host, port=args.port, recordings_path=args.recordings)
